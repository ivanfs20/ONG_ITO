...
<nav class="navbar">
    ...
    <div class="nav-links">
        <a href="view/sesionadmin.php" class="nav-link">Inicio</a>
        <a href="view/gestiondedonaciones.php" class="nav-link">Donaciones</a>
        <a href="view/gestionpb.php" class="nav-link">Proyectos</a>
        <a href="view/gestiondeusuarios.php" class="nav-link">Usuarios</a>
